		...
		<header id="site-header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
	  		<div class="container">	
	  			<div id="header">
					...
					<?php if($mts_options['mts_header_ad'] && $mts_options['mts_header_adcode']) { ?>
						<div class="header-banner">
							<div style="<?php mts_ad_size_value($mts_options['mts_header_ad_size']); ?> float:right;">
								<?php echo $mts_options['mts_header_adcode']; ?>
							</div>
						</div>
					<?php } elseif ( !empty($mts_options['mts_header_social']) && is_array($mts_options['mts_header_social']) && !empty($mts_options['mts_social_icon_head'])) { ?>
